...
preencher este campo.”>
  ...
  <div class="form-group">
    ...
    <textarea rows="3" class="form-control" pattern="[A-Za-z ]+" required x-moz-errormessage=”Você esqueceu de
preencher este campo.” nome="outrositens"></textarea>

  </div>
  <div class="form-group">
    <label for="exampleInputName2">Informe aqui o que você quer doar</label>
    <input type="text" class="form-control" id="exampleInputName2"  pattern="[A-Za-z ]+" required x-moz-errormessage=”Você esqueceu de
