...
<html lang="pt-br">
  ...
  <body>
    ...
    <h1 align="center">Doe Tempo</h1><br>
      ...
      <center style="margin-top: 1%; margin-right: 1%; margin-bottom: 4cm; margin-left: 1%; padding: 6px;">
      <img src="../images/temp.png" style="width: 400px; height: 300px;"
      class="img-responsive" alt="Responsive image"></center>
      <br>
    <p align="justify" >&ensp;   Para doar tempo é muito fácil basta você estar cadastrado em nosso
    site, e preencher o formulário clicando no botão abaixo, assim você poderá participar de umas de
    nossas visitações a ONG's e Hospitais no qual você deseja ir.</p>
       <p><a class="btn btn-primary btn-lg" href="../doacoes/formulariotempo.html" role="button">Clique para doar</a></p>
      </div>
